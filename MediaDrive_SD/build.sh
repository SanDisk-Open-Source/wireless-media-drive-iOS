...
RESULT_DIR="./app/MediaDriveSD.app"
...
$XCODE_BASE/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang -std=c++11 -stdlib=libstdc++ \
 ...
 -o "$RESULT_DIR/MediaDriveSD"

plutil -convert xml1 -o "MediaDriveSD.xcent" "Entitlements.plist"
...
/usr/bin/codesign --force --sign $"YOUR_IDENTITY" --resource-rules="ResourceRules.plist" --entitlements "MediaDriveSD.xcent" "$RESULT_DIR"
